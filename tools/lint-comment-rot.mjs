...
//
// Run: node tools/lint-comment-rot.mjs [--base <ref>] [--staged] [--all] [--json]
...
// What this tree holds: Rust crates, TOML manifests, the CI workflows, the
// gate's shell script, the Python tools and this script. Markdown is prose
// rather than comments, STEP and IGES fixtures carry no commentary worth
// gating, and `.lock` is generated.
...
// Test data is not prose: the exchange corpus, and the scratch outputs a
// test writes beside itself.
const SKIP_PATH = [/(^|\/)tests\/(?:data|corpus)\//];
