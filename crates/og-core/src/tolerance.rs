...
impl Tolerances {
    ...
    /// # Errors
    ///
    /// [`OgError::Construction`](crate::OgError::Construction) if the scale is
    /// not finite and positive.
    pub fn with_scale(mm_per_unit: f64) -> OgResult<Self> {
...
impl Tolerance {
    ...
    /// # Errors
    ///
    /// [`OgError::Construction`](crate::OgError::Construction) if `value` is not
    ...
    pub fn new(value: f64) -> OgResult<Self> {
...
/// # Errors
///
/// [`OgError::Invariant`](crate::OgError::Invariant) if `bounding` is tighter
/// than `bounded`.
