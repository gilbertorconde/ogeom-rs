...
pub use build::{
    ...
    is_wire_closed, make_apex_band, make_band_between, make_compound, make_compsolid, make_edge,
    make_edge_between, make_face, make_face_on, make_face_with_pcurves, make_natural_face,
