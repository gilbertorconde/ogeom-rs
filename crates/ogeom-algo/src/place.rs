...
pub fn transformed(model: &mut Model, shape: &Shape, transform: Transform) -> OgeomResult<Built> {
...
mod tests {
    ...
    fn placing_or_copying_a_stranger_is_an_error() {
        ...
        for _ in 0..4 {
            other.add_vertex(ogeom_topo::VertexData::new(Point::ORIGIN));
        }
        let beyond = other.add_vertex(ogeom_topo::VertexData::new(Point::ORIGIN));
