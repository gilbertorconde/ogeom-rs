...
impl Circle {
    ...
    pub fn through(a: Point, b: Point, c: Point, tol: Tolerances) -> OgResult<Self> {
        let (ab, ac) = (b - a, c - a);
...
impl Parabola {
    ...
    /// # Errors
    ///
    /// [`OgError::Construction`](og_core::OgError::Construction) if `focal` is
    /// not finite and positive. A zero focal length degenerates to a ray.
    pub fn new(frame: Frame, focal: f64, tol: Tolerances) -> OgResult<Self> {
...
impl Circle2 {
    ...
    /// [`OgError::Construction`](og_core::OgError::Construction) if `radius` is
    /// not finite and positive.
    pub fn new(frame: Frame2, radius: f64, tol: Tolerances) -> OgResult<Self> {
        check_positive("circle radius", radius, tol)?;
        Ok(Self { frame, radius })
    }
    ...
    ///
    /// As [`Circle2::new`].
    pub fn centred(centre: Point2, radius: f64, tol: Tolerances) -> OgResult<Self> {
...
impl Ellipse2 {
    ...
    /// # Errors
    ///
    /// [`OgError::Construction`](og_core::OgError::Construction) if a radius is
...
impl Parabola2 {
    ...
    /// [`OgError::Construction`](og_core::OgError::Construction) if `focal` is
    /// not finite and positive.
    pub fn new(frame: Frame2, focal: f64, tol: Tolerances) -> OgResult<Self> {
        check_positive("focal length", focal, tol)?;
        Ok(Self { frame, focal })
    }
