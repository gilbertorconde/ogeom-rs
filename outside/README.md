...
argue the scope change first, in writing, then move the code. Mesh → b-rep with
canonical recognition went that way: `docs/SCOPE.md` admits it, and the kernel's
`solid_from_mesh` replaced the crate that held it here.
